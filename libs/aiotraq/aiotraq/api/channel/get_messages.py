...
from ...models.get_messages_order import GetMessagesOrder
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, GetMessagesOrder] = GetMessagesOrder.DESC,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, GetMessagesOrder]):  Default: GetMessagesOrder.DESC.
