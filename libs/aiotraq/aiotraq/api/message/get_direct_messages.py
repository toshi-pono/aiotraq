...
from ...models.get_direct_messages_order import GetDirectMessagesOrder
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, GetDirectMessagesOrder] = GetDirectMessagesOrder.DESC,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, GetDirectMessagesOrder]):  Default: GetDirectMessagesOrder.DESC.
